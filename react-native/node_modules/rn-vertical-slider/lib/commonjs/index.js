...
const VerticalSlider = _ref => {
  ...
  // Helper Variables
  const _moveStartValue = (0, _reactNativeReanimated.useSharedValue)(0);
  const _value = (0, _reactNativeReanimated.useSharedValue)(currentValue);
  const value = new _reactNativeReanimated.default.Value(currentValue);
  ...
  const sliderStyle = (0, _reactNativeReanimated.useAnimatedStyle)(() => ({
    height: (_value.value - min) * height / (max - min),
    backgroundColor: minimumTrackTintColor,
    borderRadius
  }), [_value]);
  const ballStyle = (0, _reactNativeReanimated.useAnimatedStyle)(() => {
    let styles = {
  ...
  }, panResponder.panHandlers), /*#__PURE__*/React.createElement(_reactNativeReanimated.default.View, {
    style: [sliderBaseStyles, styles.slider, sliderStyle]
  })), showBallIndicator && /*#__PURE__*/React.createElement(_reactNativeReanimated.default.View, {
    style: [styles.ball, shadowStyles, ballStyle],
    pointerEvents: "none"
  }, renderIndicator ?
  // @ts-ignore
  renderIndicator(_value.value) : /*#__PURE__*/React.createElement(_reactNativeReanimated.default.Text, {
